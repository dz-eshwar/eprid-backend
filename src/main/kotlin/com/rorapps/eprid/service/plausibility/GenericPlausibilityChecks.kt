...
/**
 * Sanity checks that are generic across waste streams (self-reported annual capacity vs. batch weight;
 * absolute batch size). Shared by [BatteryPlausibilityStrategy] and [TyrePlausibilityStrategy] — not
 ...
 */
internal fun checkCapacityCeiling(batchT: BigDecimal, annualCapacityT: BigDecimal?): PlausibilitySubCheck {
