...
- Frontend: `/calculator` → `CalculatorForm` → `CalculatorResult` — **not updated this pass, will break against the new `BatteryCategory` values** (see §6's follow-up note)
